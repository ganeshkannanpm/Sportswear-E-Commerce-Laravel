...
<head>
    ...
    <title>Checkout - Sportswear</title>
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="bg-white p-6 shadow rounded-xl">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <input type="text" placeholder="Full Name"
                            class="border p-3 rounded-lg w-full focus:outline-none focus:ring-2 focus:ring-blue-600">
                        <input type="email" placeholder="Email Address"
                            class="border p-3 rounded-lg w-full focus:outline-none focus:ring-2 focus:ring-blue-600">
                        <input type="text" placeholder="Mobile Number"
                            class="border p-3 rounded-lg w-full focus:outline-none focus:ring-2 focus:ring-blue-600 md:col-span-2">
                    </div>
                </div>
                ...
                <div class="bg-white p-6 shadow rounded-xl">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <select class="border p-3 rounded-lg w-full focus:outline-none focus:ring-2 focus:ring-blue-600">
                ...
                <div class="bg-white p-6 shadow rounded-xl">
                    ...
                    <div class="space-y-4">
                        <label class="flex items-center gap-3 border rounded-lg p-4 cursor-pointer hover:bg-gray-100">
                ...
                <div class="bg-white p-6 shadow rounded-xl">
                    ...
                    <div class="space-y-4">
                        <label class="flex items-center gap-3 border p-4 rounded-lg cursor-pointer hover:bg-gray-100">
                ...
                <div class="bg-white p-6 shadow rounded-xl">
                    ...
                    <div class="space-y-4 mb-4">
                        ...
                        <div class="flex items-center gap-4">
                            <img src="https://via.placeholder.com/90" class="h-20 w-20 rounded-lg">
                            <div class="flex-1">
