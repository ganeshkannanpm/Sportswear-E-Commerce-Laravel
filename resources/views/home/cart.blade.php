...
<div class="max-w-7xl mx-auto px-4 py-10">
            ...
            <tbody>
                ...
                <tr class="border-b">
                    <td class="py-4 px-4 flex items-center gap-4">
                        <img src="https://via.placeholder.com/80" class="w-20 h-20 rounded-md object-cover" />
                        <div>
    ...
    <div class="mt-10 grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="bg-white shadow rounded-lg p-6">
            ...
            <button class="w-full bg-green-600 text-white text-lg py-3 rounded-lg hover:bg-green-700 mt-4">
                Proceed to Checkout
            </button>
        </div>
    </div>
