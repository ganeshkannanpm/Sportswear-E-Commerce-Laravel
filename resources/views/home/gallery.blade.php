<x-layout>
    ...
    <body class="bg-gray-50 text-gray-800">
        ...
        <!-- 🌟 Header / Hero Section -->
        <section
            class="relative bg-[url('https://images.unsplash.com/photo-1521412644187-c49fa049e84d?auto=format&fit=crop&w=1950&q=80')] bg-cover bg-center h-72 flex items-center">
        ...
        <section class="container mx-auto px-6 mt-10">
            ...
            <div class="flex flex-wrap gap-3">
                <button class="px-4 py-2 bg-red-800 text-white rounded-lg hover:bg-red-900">All</button>
        ...
        <section class="container mx-auto px-6 mt-12">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                ...
                <div class="rounded-xl overflow-hidden shadow-lg hover:scale-[1.02] transition">
                    <img src="https://images.unsplash.com/photo-1599058917212-d750089bc07e?auto=format&fit=crop&w=1000&q=80"
                        class="w-full h-56 object-cover" />
                </div>

                <div class="rounded-xl overflow-hidden shadow-lg hover:scale-[1.02] transition">
                    <img src="https://images.unsplash.com/photo-1594381898411-846e7d193883?auto=format&fit=crop&w=1000&q=80"
                        class="w-full h-56 object-cover" />
                </div>
                ...
                <div class="rounded-xl overflow-hidden shadow-lg hover:scale-[1.02] transition">
                    <img src="https://images.unsplash.com/photo-1579758629938-03607ccdbaba?auto=format&fit=crop&w=1000&q=80"
                        class="w-full h-56 object-cover" />
                </div>
        ...
        <section class="container mx-auto px-6 mt-16 mb-20">
            <div class="bg-gray-900 text-white p-10 rounded-2xl text-center">
                ...
                <p class="mt-2 text-gray-300">We create premium brand shoots for fitness, running, gym and outdoor
                    sportswear.</p>
                <a href="#"
                    class="inline-block mt-6 px-6 py-3 bg-white text-gray-900 font-bold rounded-lg hover:bg-gray-200">
                    Contact Us
                </a>
            </div>
        </section>
